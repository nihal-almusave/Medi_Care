        ...
        while (SDL_PollEvent(&event)!=0)
        {
            ...
            else if (event.type==SDL_MOUSEBUTTONDOWN||event.type==SDL_TEXTINPUT||event.type==SDL_KEYDOWN)
            {
                ...
                else if (menu==3)
                {
                    ...
                    {
                        if (strstr(input_symptoms.c_str(),"01")||strstr(input_symptoms.c_str(),"1")||strstr(input_symptoms.c_str(),"02")||strstr(input_symptoms.c_str(),"2")||strstr(input_symptoms.c_str(),"03")||strstr(input_symptoms.c_str(),"3")||strstr(input_symptoms.c_str(),"04")||strstr(input_symptoms.c_str(),"4")||strstr(input_symptoms.c_str(),"05")||strstr(input_symptoms.c_str(),"5")||strstr(input_symptoms.c_str(),"06")||strstr(input_symptoms.c_str(),"6")||strstr(input_symptoms.c_str(),"07")||strstr(input_symptoms.c_str(),"7")||strstr(input_symptoms.c_str(),"08")||strstr(input_symptoms.c_str(),"8")||strstr(input_symptoms.c_str(),"09")||strstr(input_symptoms.c_str(),"9")||strstr(input_symptoms.c_str(),"10")||strstr(input_symptoms.c_str(),"11")||strstr(input_symptoms.c_str(),"12")||strstr(input_symptoms.c_str(),"13")||strstr(input_symptoms.c_str(),"14")||strstr(input_symptoms.c_str(),"15")||strstr(input_symptoms.c_str(),"16")||strstr(input_symptoms.c_str(),"17")||strstr(input_symptoms.c_str(),"18")||strstr(input_symptoms.c_str(),"19")||strstr(input_symptoms.c_str(),"20")||strstr(input_symptoms.c_str(),"21")||strstr(input_symptoms.c_str(),"22")||strstr(input_symptoms.c_str(),"23")||strstr(input_symptoms.c_str(),"24")||strstr(input_symptoms.c_str(),"25")||strstr(input_symptoms.c_str(),"26")||strstr(input_symptoms.c_str(),"27")||strstr(input_symptoms.c_str(),"28")||strstr(input_symptoms.c_str(),"29")||strstr(input_symptoms.c_str(),"30")||strstr(input_symptoms.c_str(),"31")||strstr(input_symptoms.c_str(),"32")||strstr(input_symptoms.c_str(),"33")||strstr(input_symptoms.c_str(),"34")||strstr(input_symptoms.c_str(),"35")||strstr(input_symptoms.c_str(),"36")||strstr(input_symptoms.c_str(),"37"))
                        {
                            clear();
                            f=0;
                            menu=4;
